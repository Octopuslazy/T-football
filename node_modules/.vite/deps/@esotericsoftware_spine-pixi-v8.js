import {
  ...
  VertexAttachment,
  WindowedMean
} from "./chunk-5LCGB2I2.js";
import {
  Assets,
  Text,
  checkExtension
} from "./chunk-RZI34LHS.js";
import "./chunk-J7UX3KRH.js";
import {
  Cache,
  Graphics,
  ...
  copySearchParams,
  path
} from "./chunk-T5QFNLYD.js";
import "./chunk-2TE32HB7.js";
import "./chunk-VKX4QOVH.js";
import "./chunk-PDZZUDAN.js";
import "./chunk-DU4EKYQF.js";
import {
  Batcher,
  Buffer,
  BufferUsage,
...
var _SpineTexture = class _SpineTexture extends Texture {
  constructor(image) {
    super(image.resource);
    __publicField(this, "texture");
    this.texture = Texture2.from(image);
  }
  static from(texture) {
      ...
      if (attachment) {
        if (attachment instanceof MeshAttachment || attachment instanceof RegionAttachment) {
          ...
          if (this.alpha === 0 || alpha === 0) {
            ...
            const texture = ((_a = attachment.region) == null ? void 0 : _a.texture.texture) || Texture2.EMPTY;
