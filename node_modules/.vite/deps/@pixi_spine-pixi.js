...
} from "./chunk-UQSTPUIR.js";
import "./chunk-QJ5CR4UC.js";
import {
  Cache,
  Graphics,
  LoaderParserPriority,
  path
} from "./chunk-UCYUTFVQ.js";
import "./chunk-B277UUZL.js";
import "./chunk-WLY22QNM.js";
import "./chunk-77ZZ7AEJ.js";
import "./chunk-N7ACFJGO.js";
import {
  Batcher,
  Buffer,
  BufferUsage,
  ...
  roundPixelsBit,
  roundPixelsBitGl
} from "./chunk-NNAIAXCB.js";

// node_modules/@pixi/spine-pixi/lib/require-shim.mjs
...
var _Skeleton = class _Skeleton {
  ...
  getBoundsRect(clipper3) {
    let offset = new Vector2();
    let size = new Vector2();
    this.getBounds(offset, size, void 0, clipper3);
    ...
    for (let i = 0, n = drawOrder.length; i < n; i++) {
      ...
      if (vertices && triangles) {
        if (clipper3 != null && clipper3.isClipping()) {
          clipper3.clipTriangles(vertices, triangles, triangles.length);
...
var SkeletonBinary = class {
  ...
  readSkeletonData(binary) {
    ...
    for (let i = 0; i < n; i++) {
      ...
      if (darkColor2 != -1)
        Color2.rgb888ToColor(data.darkColor = new Color2(), darkColor2);
...
// node_modules/@pixi/spine-pixi/lib/SpineTexture.mjs
...
var _SpineTexture = class _SpineTexture2 extends Texture2 {
  constructor(image) {
  ...
  static from(texture) {
    if (_SpineTexture2.textureMap.has(texture)) {
      return _SpineTexture2.textureMap.get(texture);
    }
    return new _SpineTexture2(texture);
  }
  setFilters(minFilter, magFilter) {
    const style = this.texture.source.style;
    style.minFilter = _SpineTexture2.toPixiTextureFilter(minFilter);
    style.magFilter = _SpineTexture2.toPixiTextureFilter(magFilter);
    this.texture.source.autoGenerateMipmaps = _SpineTexture2.toPixiMipMap(minFilter);
    this.texture.source.updateMipmaps();
  }
  setWraps(uWrap, vWrap) {
    const style = this.texture.source.style;
    style.addressModeU = _SpineTexture2.toPixiTextureWrap(uWrap);
    style.addressModeV = _SpineTexture2.toPixiTextureWrap(vWrap);
  }
  dispose() {
...
__publicField2(_SpineTexture, "textureMap", /* @__PURE__ */ new Map());
var SpineTexture = _SpineTexture;

// node_modules/@pixi/spine-pixi/lib/assets/atlasLoader.mjs
...
// node_modules/@pixi/spine-pixi/lib/assets/skeletonLoader.mjs
...
// node_modules/@pixi/spine-pixi/lib/darktint/DarkTintBatchGeometry.mjs
...
// node_modules/@pixi/spine-pixi/lib/darktint/darkTintBit.mjs
var darkTintBit = {
  name: "color-bit",
  vertex: {
    header: (
...
// node_modules/@pixi/spine-pixi/lib/darktint/DarkTintShader.mjs
...
// node_modules/@pixi/spine-pixi/lib/darktint/DarkTintBatcher.mjs
...
var _DarkTintBatcher = class _DarkTintBatcher2 extends Batcher {
  constructor() {
    super(...arguments);
    __publicField3(this, "geometry", new DarkTintBatchGeometry());
    __publicField3(this, "shader", defaultShader || (defaultShader = new DarkTintShader(this.maxTextures)));
    __publicField3(this, "name", _DarkTintBatcher2.extension.name);
    __publicField3(this, "vertexSize", 7);
  }
  packAttributes(element, float32View, uint32View, index, textureId) {
    ...
    const darkColor2 = Color.shared.setValue(element.darkColor).premultiply(worldAlpha, true).toPremultiplied(1, false);
...
__publicField3(_DarkTintBatcher, "extension", {
  type: [
...
// node_modules/@pixi/spine-pixi/lib/BatchableSpineSlot.mjs
...
var BatchableSpineSlot = class {
  constructor() {
    __publicField4(this, "indexOffset", 0);
    __publicField4(this, "attributeOffset", 0);
    __publicField4(this, "indexSize");
    __publicField4(this, "attributeSize");
    __publicField4(this, "batcherName", "darkTint");
    __publicField4(this, "packAsQuad", false);
    __publicField4(this, "renderable");
    __publicField4(this, "positions");
    __publicField4(this, "indices");
    __publicField4(this, "uvs");
    __publicField4(this, "roundPixels");
    __publicField4(this, "data");
    __publicField4(this, "blendMode");
    __publicField4(this, "darkTint");
    __publicField4(this, "texture");
    __publicField4(this, "transform");
    __publicField4(this, "_textureId");
    __publicField4(this, "_attributeStart");
    __publicField4(this, "_indexStart");
    __publicField4(this, "_batcher");
    __publicField4(this, "_batch");
  }
  get color() {
...
// node_modules/@pixi/spine-pixi/lib/SpinePipe.mjs
...
var SpinePipe = class {
  constructor(renderer) {
    ...
    __publicField5(this, "gpuSpineData", {});
...
__publicField5(SpinePipe, "extension", {
  type: [
...
// node_modules/@pixi/spine-pixi/lib/Spine.mjs
...
var lightColor = new Color2();
var darkColor = new Color2();
Skeleton.yDown = true;
...
var Spine = class _Spine extends ViewContainer {
  constructor(options) {
    ...
    super();
    __publicField6(this, "batched", true);
    __publicField6(this, "buildId", 0);
    __publicField6(this, "renderPipeId", "spine");
    __publicField6(this, "_didSpineUpdate", false);
    __publicField6(this, "beforeUpdateWorldTransforms", () => {
    });
    __publicField6(this, "afterUpdateWorldTransforms", () => {
    });
    __publicField6(this, "skeleton");
    __publicField6(this, "state");
    __publicField6(this, "skeletonBounds");
    __publicField6(this, "_debug");
    __publicField6(this, "_slotsObject", /* @__PURE__ */ Object.create(null));
    __publicField6(this, "spineAttachmentsDirty", true);
    __publicField6(this, "spineTexturesDirty", true);
    __publicField6(this, "_lastAttachments");
    __publicField6(this, "_stateChanged", true);
    __publicField6(this, "attachmentCacheData", []);
    __publicField6(this, "autoUpdateWarned", false);
    __publicField6(this, "_autoUpdate", true);
  ...
  static from({ skeleton, atlas, scale = 1 }) {
    ...
    if (Cache.has(cacheKey)) {
      return new _Spine(Cache.get(cacheKey));
    }
...
// node_modules/@pixi/spine-pixi/lib/SpineDebugRenderer.mjs
...
var SpineDebugRenderer = class {
  constructor() {
    __publicField7(this, "registeredSpines", /* @__PURE__ */ new Map());
    __publicField7(this, "drawMeshHull", true);
    __publicField7(this, "drawMeshTriangles", true);
    __publicField7(this, "drawBones", true);
    __publicField7(this, "drawPaths", true);
    __publicField7(this, "drawBoundingBoxes", true);
    __publicField7(this, "drawClipping", true);
    __publicField7(this, "drawRegionAttachments", true);
    __publicField7(this, "drawEvents", true);
    __publicField7(this, "lineWidth", 1);
    __publicField7(this, "regionAttachmentsColor", 30975);
    __publicField7(this, "meshHullColor", 30975);
    __publicField7(this, "meshTrianglesColor", 16763904);
    __publicField7(this, "clippingPolygonColor", 16711935);
    __publicField7(this, "boundingBoxesRectColor", 65280);
    __publicField7(this, "boundingBoxesPolygonColor", 65280);
    __publicField7(this, "boundingBoxesCircleColor", 65280);
    __publicField7(this, "pathsCurveColor", 16711680);
    __publicField7(this, "pathsLineColor", 16711935);
    __publicField7(this, "skeletonXYColor", 16711680);
    __publicField7(this, "bonesColor", 61132);
    __publicField7(this, "eventFontSize", 24);
    __publicField7(this, "eventFontColor", 0);
  }
  /**
...
//# sourceMappingURL=@pixi_spine-pixi.js.map
