...
export default class Ball extends PIXI.Container {
    constructor(gameState, goal) {
        super();
        this._velocity = { x: 0, y: 0, z: 0 }; // Added z for height
        this._height = 0; // Current height above ground
        this._gravity = 1; // Stronger gravity for more realistic arc
        this._bounceStrength = 0.6; // Less bouncy for more realistic effect
        this._friction = 0.98;
        this._airResistance = 0.995; // Friction when in air
        ...
        this._minSpeed = 15;
        this._maxSpeed = 45;
        this._baseScale = 1.2; // Store original scale for perspective calculation
